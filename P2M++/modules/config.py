...
def create_parser():
    ...
    parser.add_argument('--vaild_file_path', help='vaild file path')
    parser.add_argument('--vaild_data_path', help='vaild data path')
    parser.add_argument('--vaild_image_path', help='vaild image path')
    ...
    parser.add_argument('--vaild_mesh_root', help='init mesh root path')
